...
// Voir app/dashboard/coach/moi/formations/page.tsx pour le contexte du
// gap corrigé le 2026-08-19. Version coach de la page de détail — toute
// leçon publiée est directement accessible, pas de notion de membre
// gratuit ni de bandeau d'upsell.
export default async function CoachMoiFormationDetailPage({
  params,
}: {
                        ...
                        {sec.lessons.map((lesson, li) => {
                          ...
                          return (
                            <div key={lesson.id}>
                              ...
                              {isAvailable ? (
                                <Link
                                  href={`/dashboard/coach/moi/formations/${formationId}/${lesson.id}`}
                                  style={{
                                    display: "flex",
                                    alignItems: "center",
                                    gap: 12,
                                ...
                                <div style={{
                                  ...
                                  <div style={{
                                    ...
                                    <PlayCircle size={12} style={{ color: "rgba(245,237,237,0.2)" }} strokeWidth={1.8} />
                                  </div>
                                  <div style={{ flex: 1 }}>
