    ...
    >
      <div style={{ width: "100%", maxWidth: 440 }}>
        ...
        <Link href="/" style={{
          ...
          color: "rgba(245,237,237,0.28)", textDecoration: "none",
        ...
        {/* Auth card */}
        <div className="ep-auth-card animate-scale-in" style={{ padding: "32px 28px" }}>
          {/* Logo + header */}
          <div className="animate-fade-up" style={{ textAlign: "center", marginBottom: 28 }}>
            <div className="ep-logo-glow" style={{ display: "flex", justifyContent: "center", marginBottom: 18 }}>
              <EPLogo size="md" showCoaching />
            </div>
            <div style={{ display: "inline-flex", alignItems: "center", gap: 6 }}>
              <User size={12} style={{ color: "rgba(224,30,30,0.65)" }} strokeWidth={2} />
          ...
          {/* Tabs */}
          <div className="animate-fade-up stagger-2" style={{ display: "flex", gap: 8, marginBottom: 28 }}>
          ...
          <div className="animate-fade-up stagger-3">
            {tab === "connexion" ? (
              <>
                <h2 style={{ fontWeight: 900, fontSize: 22, color: "#F5EDED", letterSpacing: "-0.04em", margin: "0 0 20px", lineHeight: 1.1 }}>
                  Mon espace client
                </h2>
                <ConnexionForm />
              </>
              ...
              <>
                <h2 style={{ fontWeight: 900, fontSize: 22, color: "#F5EDED", letterSpacing: "-0.04em", margin: "0 0 4px", lineHeight: 1.1 }}>
                  Rejoindre le coaching
                </h2>
                <p style={{ fontSize: 12, color: "rgba(245,237,237,0.35)", margin: "0 0 20px" }}>
