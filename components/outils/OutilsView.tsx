...
//
// Extrait de app/outils/page.tsx le 2026-08-16 (MASTERCLASS, audit
// métadonnées SEO) : un composant client ne peut jamais exporter
// `metadata`, ce qui privait cette page (pourtant un bon candidat SEO,
// "calculateur TDEE gratuit" etc.) de tout titre/description dédié. La
